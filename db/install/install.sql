-- Purpose: Official database install entry point for Oracle Notification Dispatch Lab.
...
prompt Oracle Notification Dispatch Lab controlled install entry point
...
define NOTIF_APP_RUNTIME_PWD = "&2"
define NOTIF_APP_READONLY_PWD = "&3"
define NOTIF_REVIEWER_PWD = "&4"
define NOTIF_LAB_DB_ROOT = "&5"
...
prompt Running managed source file: &&NOTIF_LAB_DB_ROOT/src/tables/lab_smoke_test.sql
